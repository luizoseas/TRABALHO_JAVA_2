 ...
 * @author oseas
 */
public class FormListarEstoque extends javax.swing.JInternalFrame {

    private FormCadastrarEstoque formCadastrarEstoque;
    /**
     * Creates new form FormListarEstoque
     */
    public FormListarEstoque() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TEXT_TITLE.setText("LISTAR ESTOQUE");
    ...
    private void BUTTON_CADASTRARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BUTTON_CADASTRARActionPerformed
        if(!(this.formCadastrarEstoque instanceof FormCadastrarEstoque)){
            this.formCadastrarEstoque = new FormCadastrarEstoque();
        }
        this.formCadastrarEstoque.setVisible(true);
